...
| [ATS-0020](./adr/ATS-0020-model-governance-boot-gate.md) | Model governance boot gate ve approved-model registry | Accepted |
| [ATS-0021](./adr/ATS-0021-worm-status-authority.md) | WORM status authority ve fail-closed projection | Accepted |
| [ATS-0022](./adr/ATS-0022-full-ats-identity-authorization-and-job-lifecycle.md) | Full ATS kimlik/yetki otoritesi, product-native kullanıcı erişimi, public career handle ve ilan yaşam döngüsü | Accepted — müşteri-öncelikli Full ATS, 2026-07-17 |
...
- [security/release-evidence-manifest.md](./security/release-evidence-manifest.md) — supply-chain/air-gap doğrulanabilir kanıt manifesti (digest-pin + SBOM + cosign + SLSA + vuln-disposition; drift-guard `release-evidence-guard`).
  ...
  - P6.4 `contracts/integrity/integrity-provenance-screening.ts` — C2PA/provenance durumunu exact asset/scope/verifier/trust/policy lineage ile append-only screening evidence olarak taşır; deepfake/authenticity/identity sonucu, kişi skoru, adverse action veya production aktivasyonu üretmez.
...
- [ai-governance/intelligence-evaluation-v1.md](./ai-governance/intelligence-evaluation-v1.md) — P6 QoH/fairness/coaching/skills/deepfake/internal-mobility/agentic proposal metric+gate protokolü; four-fifths/deepfake screening-only, human-oversight ref-only, scoring/ranking/affect/otonom action yasak (drift-guard `intelligence-evaluation-guard`).
- [ai-governance/quality-of-hire-evidence-v1.md](./ai-governance/quality-of-hire-evidence-v1.md) — P6.0 QoH dedicated sentetik evaluator; 90/180 gün × dört outcome boyutu, statistical-vs-disclosure minimumu, contestable/descriptive/no-causality, destroyable-linkage ve legal/audit/customer/owner activation kapıları kapalı.
- [ai-governance/integrity-provenance-screening-v1.md](./ai-governance/integrity-provenance-screening-v1.md) — P6.4 C2PA/provenance screening receipt semantiği; `NOT_PRESENT ≠ deepfake`, `VERIFIED_BINDING ≠ truth/identity`, append-only correction ve kapalı legal/owner gate sınırı.
