...
| **T-D3** | DoS | K6 | Veri-kaybı / kurtarılamama (backup bütünlüğü, restore başarısızlığı, RTO/RPO aşımı) | Şifreli backup + **restore drill** + RTO/RPO + erasure-aware destruction-propagation — [[ATS-0003]] · on-prem checklist §6 | backup/restore drill (owner) | gate-locked |
