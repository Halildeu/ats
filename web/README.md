...
> - 🔒 Gate-locked (G0=GO / P1): gerçek React bileşeni, JSX/render, story/screen, axe/eslint runtime harness, ingest/STT/diarization/LLM/citation-runtime, backend/PII/WORM, export/render, ATS write-back, persistence, finalize.
