...
- 🔓 Persistence unlock: [ATS-0018](../docs/adr/ATS-0018-persistence-unlock-postgres-jdbc.md) — **PG16 + Flyway + plain-JDBC tek-adapter-modülü (`persistence-postgres`); JPA/Hibernate/Spring-Data KULLANILMAZ**. Durum: **8a worm_ledger + 8b 6-store adapter LANDED** (Testcontainers-PG16 kanıtı; PG-smoke: CitationService uçtan-uca PG üzerinde); **8c retention-timer PENDING**; prod deploy/DSN/Vault wiring YOK.
